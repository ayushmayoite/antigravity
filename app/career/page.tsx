      ...
      <section className="container px-6 2xl:px-0 py-24">
        <div className="max-w-4xl space-y-8 mb-24">
          ...
          <p className="text-xl md:text-2xl font-light text-neutral-600 leading-relaxed">
            At One and Only, we combine tradition with innovation. We are
            looking for people who want to change the world of work with us.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-10 bg-neutral-50 rounded-3xl hover:bg-white border border-transparent hover:border-neutral-200 transition-all duration-500 group">
            ...
            <p className="text-neutral-500 font-light leading-relaxed">
              Short decision paths, a supportive team, and a family-run business
          ...
          <div className="p-10 bg-neutral-50 rounded-3xl hover:bg-white border border-transparent hover:border-neutral-200 transition-all duration-500 group">
            ...
            <p className="text-neutral-500 font-light leading-relaxed">
              We invest in your future through continuous training, development
              programs, and clear paths for growth.
            </p>
          </div>
          <div className="p-10 bg-neutral-50 rounded-3xl hover:bg-white border border-transparent hover:border-neutral-200 transition-all duration-500 group">
            ...
            <p className="text-neutral-500 font-light leading-relaxed">
              Flexible working models, health benefits, and a culture that
              respects your private life and wellbeing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container px-6 2xl:px-0">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8 text-center md:text-left">
              ...
              <p className="text-neutral-500 font-light pb-1">
            ...
            <div className="mt-20 p-12 bg-white rounded-3xl border border-neutral-200 text-center space-y-6">
              ...
              <p className="text-neutral-500 font-light max-w-xl mx-auto">
                ...
                Send us an unsolicited application and tell us how you can
                contribute to One and Only.
              </p>
              <Button
                variant="link"
                ...
                asChild
              >
                <a href="mailto:careers@oando.co.in">careers@oando.co.in</a>
              </Button>
            </div>
          </div>
        </div>
