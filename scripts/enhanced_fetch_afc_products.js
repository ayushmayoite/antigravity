...
async function fetchProductData(productUrl) {
    try {
        ...
        const description = metaDescription || firstParagraph || 'Premium furniture solution from AFC India';
...
async function main() {
    try {
        console.log('Starting enhanced AFC product scraping...');
...
function integrateIntoCatalog(products) {
    ...
    ${afcCatalogString.substring(1, afcCatalogString.length - 1)},`
        ...
        console.log(`Integrated ${products.length} enhanced AFC products`);
    }
}
